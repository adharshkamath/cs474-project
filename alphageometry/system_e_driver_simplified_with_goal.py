...
AB1, BC1, CA1, AD1, AE1, BF1, CG1, IA1 = Consts('AB1 BC1 CA1 AD1 AE1 BF1 CG1 IA1', systemE.LineSort)
...
assumptions.append(systemE.Intersectsll(BF1, CG1))
assumptions.append(systemE.Intersectslc(BF1, OABC))
assumptions.append(systemE.Intersectslc(CG1, OABC))
assumptions.append(systemE.OnLine(H1,BF1))
assumptions.append(systemE.OnLine(H1,CG1))
assumptions.append(systemE.OnCircle(H1, OABC))
