...
A1, B1, C1, D1, E1, F1, G1, H1, I1, J1 = Consts('A1 B1 C1 D1 E1 F1 G1 H1 I1 J1', systemE.PointSort)
solver.add(simplify(Distinct(A1,B1,C1,D1,E1,F1), blast_distinct=True))

AB1, BC1, CA1, FD1, GE1, BF1, CG1, IA1 = Consts('AB1 BC1 CA1 FD1 GE1 BF1 CG1 IA1', systemE.LineSort)
...
assumptions.append(systemE.OnLine(I1, IA1))
assumptions.append(systemE.OnLine(A1, IA1))
assumptions.append(systemE.OnLine(J1, IA1))
assumptions.append(systemE.Between(A1, I1, J1))
assumptions.append(systemE.Segment(I1, J1) == systemE.Segment(I1, A1))
