...
(declare-fun |Intersectsll(BF1, CG1)| () Bool)
(declare-fun |Intersectslc(BF1, OABC)| () Bool)
(declare-fun |Intersectslc(CG1, OABC)| () Bool)
(declare-fun H1 () Point)
(declare-fun |On(H1, BF1)| () Bool)
(declare-fun |On(H1, CG1)| () Bool)
(declare-fun |Onc(H1, OABC)| () Bool)
(assert
...
(assert
 ...
 (=> |Onc(C1, OABC)| $x1153)))
(assert
 (let (($x1154 (Intersectsll BF1 CG1)))
 (=> |Intersectsll(BF1, CG1)| $x1154)))
(assert
 (let (($x1155 (Intersectslc BF1 OABC)))
 (=> |Intersectslc(BF1, OABC)| $x1155)))
(assert
 (let (($x1156 (Intersectslc CG1 OABC)))
 (=> |Intersectslc(CG1, OABC)| $x1156)))
(assert
 (let (($x1157 (On H1 BF1)))
 (=> |On(H1, BF1)| $x1157)))
(assert
