...
(assert
 (let (($x891 (not (= BC1 CA1))))
 (let (($x516 (not (= AB1 CA1))))
 (let (($x879 (not (= AB1 BC1))))
 (and $x879 $x516 $x891)))))
(assert
 (not (= FD1 GE1)))
(assert
...
(assert
 true)
(assert
 (let (($x885 (Intersectsll AB1 BC1)))
 (=> |Intersectsll(AB1, BC1)| $x885)))
(assert
 (let (($x896 (Intersectsll BC1 CA1)))
 (=> |Intersectsll(BC1, CA1)| $x896)))
(assert
 (let (($x908 (Intersectsll CA1 AB1)))
 (=> |Intersectsll(CA1, AB1)| $x908)))
(assert
 (let (($x910 (On A1 AB1)))
 (=> |On(A1, AB1)| $x910)))
(assert
...
(assert
 ...
 (=> |On(A1, CA1)| $x992)))
(assert
 (let (($x7 (not (On B1 CA1))))
 (=> |Not(On(B1, CA1))| $x7)))
(assert
 (let (($x1067 (On D1 BC1)))
 (=> |On(D1, BC1)| $x1067)))
(assert
 (let (($x1076 (= (Angle D1 A1 B1) (Angle B1 C1 A1))))
 (=> |Angle(D1, A1, B1) == Angle(B1, C1, A1)| $x1076)))
(assert
 (let (($x1077 (On E1 BC1)))
 (=> |On(E1, BC1)| $x1077)))
(assert
 (let (($x1080 (= (Angle E1 A1 C1) (Angle C1 B1 A1))))
 (=> |Angle(E1, A1, C1) == Angle(C1, B1, A1)| $x1080)))
(assert
 (let (($x1083 (On F1 FD1)))
 (=> |On(F1, FD1)| $x1083)))
(assert
...
(assert
 ...
 (=> |On(A1, FD1)| $x1087)))
(assert
 (let (($x1090 (= (Segment F1 D1) (Segment D1 A1))))
 (=> |Segment(F1, D1) == Segment(D1, A1)| $x1090)))
(assert
 (let (($x1091 (On G1 GE1)))
 (=> |On(G1, GE1)| $x1091)))
(assert
...
(assert
 ...
 (=> |On(A1, GE1)| $x1093)))
(assert
 (let (($x1096 (= (Segment G1 E1) (Segment E1 A1))))
 (=> |Segment(G1, E1) == Segment(E1, A1)| $x1096)))
(assert
 (let (($x1099 (On B1 BF1)))
 (=> |On(B1, BF1)| $x1099)))
(assert
...
(assert
 ...
 (=> |On(H1, BF1)| $x1105)))
(assert
 (let (($x1107 (Center I1 OABC)))
 (=> |Center(I1, OABC)| $x1107)))
(assert
 (let (($x1108 (Onc A1 OABC)))
 (=> |Onc(A1, OABC)| $x1108)))
(assert
 (let (($x1109 (Onc B1 OABC)))
 (=> |Onc(B1, OABC)| $x1109)))
(assert
 (let (($x1110 (Onc C1 OABC)))
 (=> |Onc(C1, OABC)| $x1110)))
(assert
