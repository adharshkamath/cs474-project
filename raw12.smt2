...
(assert
 ...
 (=> |On(D1, BC1)| $x667)))
(assert
 (let (($x1028 (= (Angle D1 A1 B1) (Angle B1 C1 A1))))
 (=> |Angle(D1, A1, B1) == Angle(B1, C1, A1)| $x1028)))
(assert
 (let (($x992 (On E1 BC1)))
 (=> |On(E1, BC1)| $x992)))
(assert
 (let (($x1067 (= (Angle E1 A1 C1) (Angle C1 B1 A1))))
 (=> |Angle(E1, A1, C1) == Angle(C1, B1, A1)| $x1067)))
(assert
 (let (($x1076 (On F1 FD1)))
 (=> |On(F1, FD1)| $x1076)))
(assert
...
(assert
 ...
 (=> |On(A1, FD1)| $x1080)))
(assert
 (let (($x1083 (= (Segment F1 D1) (Segment D1 A1))))
 (=> |Segment(F1, D1) == Segment(D1, A1)| $x1083)))
(assert
 (let (($x1084 (On G1 GE1)))
 (=> |On(G1, GE1)| $x1084)))
(assert
...
(assert
 ...
 (=> |On(A1, GE1)| $x1086)))
(assert
 (let (($x1089 (= (Segment G1 E1) (Segment E1 A1))))
 (=> |Segment(G1, E1) == Segment(E1, A1)| $x1089)))
(assert
 (let (($x1092 (On B1 BF1)))
 (=> |On(B1, BF1)| $x1092)))
(assert
...
(assert
 ...
 (=> |On(H1, BF1)| $x1098)))
(assert
 (let (($x1100 (Center I1 OABC)))
 (=> |Center(I1, OABC)| $x1100)))
(assert
 (let (($x1101 (Onc A1 OABC)))
 (=> |Onc(A1, OABC)| $x1101)))
(assert
 (let (($x1102 (Onc B1 OABC)))
 (=> |Onc(B1, OABC)| $x1102)))
(assert
 (let (($x1103 (Onc C1 OABC)))
 (=> |Onc(C1, OABC)| $x1103)))
(assert
