...
(declare-fun IA1 () Line)
(declare-fun |On(I1, IA1)| () Bool)
(declare-fun |On(A1, IA1)| () Bool)
(declare-fun J1 () Point)
(declare-fun |On(J1, IA1)| () Bool)
(declare-fun |Between(A1, I1, J1)| () Bool)
(declare-fun |Segment(I1, J1) == Segment(I1, A1)| () Bool)
(assert
...
(assert
 ...
 (let (($x1097 (not (= GE1 CG1))))
 (let (($x1095 (not (= GE1 BF1))))
 (let (($x1093 (not (= FD1 CG1))))
 (let (($x1091 (not (= FD1 BF1))))
 (let (($x1089 (not (= FD1 GE1))))
 (let (($x1087 (not (= CA1 CG1))))
 (let (($x1085 (not (= CA1 BF1))))
 (let (($x1083 (not (= CA1 GE1))))
 (let (($x1081 (not (= CA1 FD1))))
 (let (($x1079 (not (= BC1 CG1))))
 (let (($x1077 (not (= BC1 BF1))))
 (let (($x1075 (not (= BC1 GE1))))
 (let (($x6 (not (= BC1 FD1))))
 (let (($x992 (not (= BC1 CA1))))
 (let (($x719 (not (= AB1 CG1))))
 (let (($x667 (not (= AB1 BF1))))
 (let (($x948 (not (= AB1 GE1))))
 (let (($x926 (not (= AB1 FD1))))
...
(assert
 ...
 (=> |On(D1, BC1)| $x1116)))
(assert
 (let (($x1119 (= (Angle D1 A1 B1) (Angle B1 C1 A1))))
 (=> |Angle(D1, A1, B1) == Angle(B1, C1, A1)| $x1119)))
(assert
 (let (($x1120 (On E1 BC1)))
 (=> |On(E1, BC1)| $x1120)))
(assert
 (let (($x1123 (= (Angle E1 A1 C1) (Angle C1 B1 A1))))
 (=> |Angle(E1, A1, C1) == Angle(C1, B1, A1)| $x1123)))
(assert
 (let (($x1124 (On F1 FD1)))
 (=> |On(F1, FD1)| $x1124)))
(assert
...
(assert
 ...
 (=> |On(A1, FD1)| $x1126)))
(assert
 (let (($x1129 (= (Segment F1 D1) (Segment D1 A1))))
 (=> |Segment(F1, D1) == Segment(D1, A1)| $x1129)))
(assert
 (let (($x1130 (On G1 GE1)))
 (=> |On(G1, GE1)| $x1130)))
(assert
...
(assert
 ...
 (=> |On(A1, GE1)| $x1132)))
(assert
 (let (($x1135 (= (Segment G1 E1) (Segment E1 A1))))
 (=> |Segment(G1, E1) == Segment(E1, A1)| $x1135)))
(assert
 (let (($x1136 (On B1 BF1)))
 (=> |On(B1, BF1)| $x1136)))
(assert
...
(assert
 ...
 (=> |On(H1, BF1)| $x1140)))
(assert
 (let (($x1141 (Center I1 OABC)))
 (=> |Center(I1, OABC)| $x1141)))
(assert
 (let (($x1142 (Onc A1 OABC)))
 (=> |Onc(A1, OABC)| $x1142)))
(assert
 (let (($x1143 (Onc B1 OABC)))
 (=> |Onc(B1, OABC)| $x1143)))
(assert
 (let (($x1144 (Onc C1 OABC)))
 (=> |Onc(C1, OABC)| $x1144)))
(assert
 (let (($x1145 (On I1 IA1)))
 (=> |On(I1, IA1)| $x1145)))
...
(assert
 ...
 (=> |On(J1, IA1)| $x1147)))
(assert
 (let (($x1148 (Between A1 I1 J1)))
 (=> |Between(A1, I1, J1)| $x1148)))
(assert
 (let ((?x1150 (Segment I1 A1)))
 (let (($x1151 (= (Segment I1 J1) ?x1150)))
 (=> |Segment(I1, J1) == Segment(I1, A1)| $x1151))))
(assert
