...
(assert
 ...
 (let (($x59 (= a c)))
 (let (($x60 (not $x59)))
 (let (($x61 (Between c b a)))
 (let (($x62 (and $x61 $x60 $x58 (not (Between b a c)))))
 ...
 (=> |ForAll([a, b, c, L],
       Implies(And(On(a, L),
               ...
               Or(Between(a, b, c),
                  ...
                  Between(a, c, b))))| $x98)))
(assert
 (let (($x85 (forall ((a Point) (b Point) (c Point) (d Point) )(let (($x81 (Between d b c)))
 (let (($x82 (not $x81)))
 ...
 (=> |ForAll([a, b, c, L],
       Implies(And(Not(On(a, L)),
               ...
               Or(SameSide(a, b, L),
                  ...
                  SameSide(b, c, L))))| $x119)))
(assert
 (let (($x125 (forall ((a Point) (b Point) (c Point) (L Line) )(let (($x104 (SameSide a b L)))
 (let (($x122 (not $x104)))
 (let (($x95 (On c L)))
 (let (($x80 (not $x95)))
 (let (($x30 (On b L)))
 ...
 (let (($x31 (On a L)))
 (let (($x116 (not $x31)))
 (let (($x123 (and $x116 $x89 $x80 $x122)))
...
(assert
 ...
 (=> |ForAll([a, b, c, L, M],
       Implies(And(Not(a == b),
               ...
               Between(a, b, c)))| $x148)))
(assert
 (let (($x160 (forall ((a Point) (b Point) (c Point) (d Point) (L Line) (M Line) (N Line) )(let (($x149 (SameSide b d M)))
 (let (($x150 (not $x149)))
 (let (($x151 (SameSide b c N)))
 (let (($x152 (SameSide c d L)))
 (let (($x31 (On d N)))
 (let (($x153 (On c M)))
 (let (($x154 (On b L)))
 (let (($x155 (On a N)))
 (let (($x156 (On a M)))
 (let (($x157 (On a L)))
 (let (($x158 (and $x157 $x156 $x155 $x154 $x153 $x31 $x152 $x151)))
 (=> $x158 $x150)))))))))))))
 ))
...
(assert
 ...
 (let (($x176 (On a M)))
 (let (($x177 (On a L)))
 (let (($x178 (and $x177 $x176 $x175 $x53 $x174 $x173 $x172 (not (SameSide d b M)) (not (On d M)) $x167)))
 (=> $x178 $x165)))))))))))))
 ))
 (=> |ForAll([a, b, c, d],
       Implies(And(On(a, L),
...
(assert
 ...
 (let (($x192 (Inside a alpha)))
 (let (($x193 (and $x192 $x191 $x190 $x142 $x31 $x30 $x35)))
 (=> $x193 $x189))))))))))))
 ))
...
(assert
 ...
 (let (($x196 (Inside b alpha)))
 (let (($x197 (or $x196 $x133)))
 (let (($x198 (Onc a alpha)))
 (let (($x200 (or (Inside a alpha) $x198)))
 (let (($x201 (and $x200 $x197 $x90)))
 (=> $x201 $x19))))))))))
 ))
 (=> |ForAll([a, b, c, alpha],
       Implies(And(Or(Inside(a, alpha), Onc(a, alpha)),
               ...
               Inside(c, alpha)))| $x203)))
(assert
 (let (($x213 (forall ((a Point) (b Point) (c Point) (alpha Circle) )(let (($x133 (Onc b alpha)))
 (let (($x207 (not $x133)))
 (let (($x209 (and (not (Inside b alpha)) $x207)))
 (let (($x90 (Between a c b)))
...
(assert
 ...
 (let (($x219 (Center a beta)))
 (let (($x220 (Center a alpha)))
 (let (($x221 (On b L)))
 (let (($x222 (On a L)))
 (let (($x34 (= c d)))
 (let (($x35 (not $x34)))
 ...
 (let (($x225 (and $x191 $x198 $x190 $x133 (not (= alpha beta)) $x35 $x222 $x221 $x220 $x219)))
 (=> $x225 $x218))))))))))))))
 ))
...
(assert
 ...
 (let (($x247 (or (Inside a alpha) $x245)))
 (let (($x248 (and $x247 $x244 $x241 $x240 (not (SameSide a b L)))))
 (=> $x248 $x237)))))))))))
 ))
 (=> |ForAll([alpha, L, a, b],
       Implies(And(Or(Inside(a, alpha), Onc(a, alpha)),
...
(assert
 ...
 (let (($x244 (or (Inside b alpha) (Onc b alpha))))
 (let (($x245 (Onc a alpha)))
 (let (($x260 (and $x245 $x244 $x259 $x258 $x256)))
 (=> $x260 $x254)))))))))))
 ))
...
(assert
 (let (($x270 (forall ((a Point) (b Point) )(let ((?x268 (Segment b a)))
 (let ((?x232 (Segment a b)))
 (= ?x232 ?x268))))
 ))
 (=> |ForAll([a, b], Segment(a, b) == Segment(b, a))| $x270)))
(assert
 (let (($x282 (forall ((a Point) (b Point) (c Point) )(let ((?x277 (Angle c b a)))
 (let ((?x278 (Angle a b c)))
 (let (($x279 (= ?x278 ?x277)))
 (let (($x59 (= a c)))
 (let (($x60 (not $x59)))
 (let (($x23 (= a b)))
...
(assert
 (let (($x296 (forall ((a Point) (b Point) (c Point) )(let ((?x291 (Area b a c)))
 (let ((?x284 (Area a b c)))
 (let (($x292 (= ?x284 ?x291)))
 (let ((?x293 (Area c a b)))
 (let (($x294 (= ?x284 ?x293)))
...
(assert
 ...
 (let (($x309 (= (Segment a b) (Segment a c))))
 (let (($x133 (Onc c beta)))
 (let (($x191 (Onc b alpha)))
 (let (($x310 (Center a beta)))
 (let (($x311 (Center a alpha)))
 (let (($x312 (and $x311 $x310 $x191 $x133 $x309)))
 (=> $x312 $x223)))))))))
 ))
...
(assert
 (let (($x378 (forall ((a Point) (b Point) (c Point) (d Point) (L Line) (M Line) )(let (($x361 (SameSide d c L)))
 (let (($x362 (SameSide b d M)))
 ...
 (let (($x153 (On b L)))
 (let (($x183 (On a L)))
 (let (($x376 (and $x183 $x153 $x375 $x31 (not (= a b)) (not (= a c)) $x370 $x89 $x143)))
...
(assert
 (let (($x360 (forall ((a Point) (b Point) (c Point) (L Line) )(let (($x34 (= a b)))
 (let (($x35 (not $x34)))
 (let (($x30 (On b L)))
 (let (($x31 (On a L)))
...
(assert
 ...
 (=> |On(D1, BC1)| $x660)))
(assert
 (let ((?x836 (Angle B1 C1 A1)))
 (let ((?x835 (Angle D1 A1 B1)))
 (let (($x837 (= ?x835 ?x836)))
...
(assert
 ...
 (=> |On(E1, BC1)| $x838)))
(assert
 (let ((?x840 (Angle C1 B1 A1)))
 (let ((?x839 (Angle E1 A1 C1)))
 (let (($x841 (= ?x839 ?x840)))
...
(assert
 ...
 (=> |On(A1, FD1)| $x645)))
(assert
 (let ((?x648 (Segment D1 A1)))
 (let ((?x646 (Segment F1 D1)))
 (let (($x649 (= ?x646 ?x648)))
...
(assert
 ...
 (=> |On(A1, GE1)| $x824)))
(assert
 (let ((?x826 (Segment E1 A1)))
 (let ((?x825 (Segment G1 E1)))
 (let (($x827 (= ?x825 ?x826)))
