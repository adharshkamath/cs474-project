            ...
            ForAll(
                ...
                Implies(
                    And(
                        ...
                        self.OnLine(a, M),
                        self.OnLine(a, N),
                        Not(self.Intersectsll(L, M)),
                        Not(self.Intersectsll(M, N))
                    ),
                    M == N,
                )
            )
        ...
        self.axioms.append(
            ForAll(
                ...
                And(
                    ...
                    self.Area(a, b, c) == self.Area(b, a, c),
                ),
            )
        )
        self.axioms.append(
            ...
            ForAll(
                ...
                Implies(
                    And(
                        self.OnLine(a, L),
                        self.OnLine(a, M),
                        # self.Intersectsll(L, M), # commented out from smt
                        self.OnLine(b, L),
                        self.OnLine(c, M),
                        Not(a == b),
                        Not(a == c),
        ...
        self.axioms.append(
            ForAll(
                ...
                Implies(
                    ...
                    self.OnLine(c, L) == (self.Area(a, b, c) == RealVal(0.0)),
                ),
            )
        )
        self.axioms.append(
            ForAll(
                ...
                Implies(
                    ...
                    self.Between(a, c, b)
                    == (self.Area(a, c, d) + self.Area(d, c, b) == self.Area(a, d, b)),
                ),
            ),
        )
